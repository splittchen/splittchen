...
### 🚀 Planned Features
- **Additional Split Types**: EXACT and PERCENTAGE splits (currently only EQUAL)
- **Export Functionality**: CSV/PDF expense reports
- **Typing Indicators**: See when others are adding expenses in real-time
- **Online Presence**: Show who's currently viewing the group
